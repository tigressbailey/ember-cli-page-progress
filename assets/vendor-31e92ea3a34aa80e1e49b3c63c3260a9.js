...
return 2===arguments.length?(n=arguments[0],o=arguments[1],t=null):(t=(e=y.apply(void 0,arguments))[0],n=e[1],void 0===(i=e[2])?o=0:a(o=i.pop())||(r=!0===o,o=i.pop())),[t,n,i,o=parseInt(o,10),r]}var b=0,_=0,E=0,w=0,R=0,C=0,O=0,T=0,A=0,S=0,k=0,P=0,x=0,N=0,M=0,L=0,I=0,D=0,j=0,B=0,F=0,U=function(){function e(e,t){var n=this
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:_,end:E,events:{begin:w,end:0},autoruns:{created:D,completed:j},run:R,join:C,defer:O,schedule:T,scheduleIterable:A,deferOnce:S,scheduleOnce:k,setTimeout:P,later:x,throttle:N,debounce:M,cancelTimers:L,cancel:I,loops:{total:B,nested:F}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
